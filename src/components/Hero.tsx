    ...
    <div className="bg-black text-white bg-[linear-gradient(to_bottom,#000,#200D42_34%,#4F21A1_65%,#A46EDB_82%)] py-[72px] sm:py-24 relative overflow-clip">
      ...
      <div className="container relative">
        <div className="flex items-center justify-center">
          ...
          >
            <span className="bg-[linear-gradient(to_right,#F87AFF,#FB93D0,#FFDD99,#C3F0B2)] text-transparent bg-clip-text [-webkit-background-clip:text]">
              Social Media Performance Alalysis
            </span>
        ...
        <div className="flex justify-center" id='about'>
          ...
          A LangFlow and DataStax AstraDB-powered prototype to analyze and optimize social media content. 
          Unlock actionable insights and elevate your strategy—experience the future of content management in its early stage
          </p>
        </div>
        <div className="flex justify-center mt-8">
